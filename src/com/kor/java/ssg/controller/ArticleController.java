...
public class ArticleController extends Controller {
	...
	private void showList() {
		...
		for (int i = forListArticles.size() - 1; i >= 0; i--) {
			...
			System.out.printf("			%d		|		%s		|		%d		|		%s		|		%s\n",
					article.id, article.title, article.hit, writerName, article.regDate);
	...
	private void doDelete() {
		...
		articleService.remove(fdArticle);
	}
	...
	public void domakeTestData() {
		...
		Container.articleDao.add(new Article(Container.articleDao.getNewId(), "제목1", "내용1", 1, Util.getNowDatestr()));
		Container.articleDao.add(new Article(Container.articleDao.getNewId(), "제목2", "내용2", 1, Util.getNowDatestr()));
		Container.articleDao.add(new Article(Container.articleDao.getNewId(), "제목3", "내용3", 1, Util.getNowDatestr()));
